    ...
    public WebDriver getLocalDriver(String OS, String browserName) {
        ...
        if (browserName.equalsIgnoreCase("chrome")) {
            ...
            if (OS.equalsIgnoreCase("OS X")) {
                System.setProperty("webdriver.chrome.driver", "Driver/Mac/ChromeDriver/chromedriver-mac-x64/chromedriver");
            ...
            if (OS.equalsIgnoreCase("OS X")) {
                ...
                System.setProperty("webdriver.chrome.driver", "Driver/Windows/ChromeDriver/chromedriver-win64/chromedriver.exe");
            }
            driver = new ChromeDriver(options);
